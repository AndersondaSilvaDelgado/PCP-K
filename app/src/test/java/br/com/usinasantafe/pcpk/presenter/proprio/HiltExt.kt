...
import androidx.testing.manifest.R.style.FragmentScenarioEmptyFragmentActivityTheme
...
inline fun <reified T : Fragment> launchFragmentInHiltContainer(
    ...
    ActivityScenario.launch<InitialActivity>(mainActivityIntent).onActivity { activity ->
        fragmentFactory?.let {
