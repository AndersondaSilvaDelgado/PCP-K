...
fun LocalRoomModel.toLocal(): br.com.usinasantafe.pcp.domain.entities.stable.Local {
    return with(this){
...
fun br.com.usinasantafe.pcp.domain.entities.stable.Local.toLocalModel(): LocalRoomModel{
    return with(this){
        LocalRoomModel(
            idLocal = this.idLocal,
            descrLocal = this.descrLocal,
