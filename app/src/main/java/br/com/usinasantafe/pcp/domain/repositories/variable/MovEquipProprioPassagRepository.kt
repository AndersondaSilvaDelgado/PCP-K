...
interface MovEquipProprioPassagRepository {
    ...
    suspend fun listPassag(): List<br.com.usinasantafe.pcp.domain.entities.variable.MovEquipProprioPassag>

    suspend fun listPassag(idMov: Long): List<br.com.usinasantafe.pcp.domain.entities.variable.MovEquipProprioPassag>
