...
fun VisitanteRoomModel.toVisitante(): br.com.usinasantafe.pcp.domain.entities.stable.Visitante {
    return with(this){
        br.com.usinasantafe.pcp.domain.entities.stable.Visitante(
...
fun br.com.usinasantafe.pcp.domain.entities.stable.Visitante.toVisitanteModel(): VisitanteRoomModel{
    return with(this){
        VisitanteRoomModel(
            idVisitante = this.idVisitante,
            cpfVisitante = this.cpfVisitante,
