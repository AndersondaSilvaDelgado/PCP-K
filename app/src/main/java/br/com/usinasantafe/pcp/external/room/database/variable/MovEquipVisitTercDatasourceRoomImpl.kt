...
class MovEquipVisitTercDatasourceRoomImpl @Inject constructor (
    ...
    override suspend fun listMovEquipVisitTercStartedClosed(): List<MovEquipVisitTercRoomModel> {
        return movEquipVisitTercDao.listMovStatusAndStatusEnvio(StatusData.CLOSE, StatusSend.STARTED)
    }
