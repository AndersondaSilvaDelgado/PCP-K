...
interface MovEquipVisitTercPassagRepository {
    ...
    suspend fun listPassag(): List<br.com.usinasantafe.pcp.domain.entities.variable.MovEquipVisitTercPassag>

    suspend fun listPassag(idMov: Long): List<br.com.usinasantafe.pcp.domain.entities.variable.MovEquipVisitTercPassag>

    suspend fun savePassag(idMov: Long): Boolean

    suspend fun savePassag(idMov: Long, passagList: List<br.com.usinasantafe.pcp.domain.entities.variable.MovEquipVisitTercPassag>): Boolean
