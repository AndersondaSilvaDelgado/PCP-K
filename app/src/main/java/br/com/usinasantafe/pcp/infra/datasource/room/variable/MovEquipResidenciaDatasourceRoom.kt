...
interface MovEquipResidenciaDatasourceRoom {
    ...
    suspend fun listMovEquipResidenciaStarted(): List<MovEquipResidenciaRoomModel>

    suspend fun listMovEquipResidenciaStartedClosed(): List<MovEquipResidenciaRoomModel>
