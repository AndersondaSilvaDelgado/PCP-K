...
class MovEquipVisitTercRepositoryImpl @Inject constructor(
    ...
    override suspend fun listMovEquipVisitTercStarted(): List<MovEquipVisitTerc> {
        return movEquipVisitTercDatasourceRoom.listMovEquipVisitTercStarted()
            .map { it.modelRoomToMovEquipVisitTerc() }
    }

    override suspend fun listMovEquipVisitTercStartedClosed(): List<MovEquipVisitTerc> {
        return movEquipVisitTercDatasourceRoom.listMovEquipVisitTercStartedClosed()
            .map { it.modelRoomToMovEquipVisitTerc() }
    }
    ...
    override suspend fun saveMovEquipVisitTerc(
        ...
        try {
            val movEquipVisitTercRoomModel =
                movEquipVisitTerc.entityToMovEquipVisitTercRoomModel(matricVigia, idLocal)
            if (!movEquipVisitTercDatasourceRoom.insertMovEquipVisitTercClose(
                    movEquipVisitTercRoomModel
                )
            ) return 0L
            if (!movEquipVisitTercSharedPreferencesDatasource.clearMovEquipVisitTerc()) return 0L
