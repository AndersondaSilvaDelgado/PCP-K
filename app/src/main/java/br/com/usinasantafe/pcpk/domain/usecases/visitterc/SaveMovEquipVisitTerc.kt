...
interface SaveMovEquipVisitTerc {
    ...
    suspend operator fun invoke(movEquipVisitTerc: br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipVisitTerc): Boolean
}
...
class SaveMovEquipVisitTercImpl @Inject constructor(
    ...
    override suspend fun invoke(movEquipVisitTerc: br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipVisitTerc): Boolean {
        val config = configRepository.getConfig()
