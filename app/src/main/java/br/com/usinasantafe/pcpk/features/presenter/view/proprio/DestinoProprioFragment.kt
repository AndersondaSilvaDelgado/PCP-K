...
class DestinoProprioFragment : Fragment() {

    companion object {
        fun newInstance() = DestinoProprioFragment()
    }

    private lateinit var viewModel: DestinoProprioViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(DestinoProprioViewModel::class.java)
