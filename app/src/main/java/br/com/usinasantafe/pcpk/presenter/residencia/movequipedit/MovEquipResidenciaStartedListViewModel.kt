...
import br.com.usinasantafe.pcpk.domain.usecases.residencia.CloseSendAllMovResidencia
import br.com.usinasantafe.pcpk.domain.usecases.residencia.RecoverListMovEquipResidenciaStarted
...
class MovEquipResidenciaStartedListViewModel @Inject constructor (
    ...
    private val recoverListMovEquipResidenciaStarted: RecoverListMovEquipResidenciaStarted,
): ViewModel() {
    ...
    fun recoverListMov() = viewModelScope.launch {
        setListMovEquip(recoverListMovEquipResidenciaStarted())
    }
