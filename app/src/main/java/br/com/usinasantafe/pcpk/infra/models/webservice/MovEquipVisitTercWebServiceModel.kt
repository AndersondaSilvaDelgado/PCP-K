...
fun br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipVisitTerc.entityToMovEquipVisitTercWebServiceModel(nroAparelho: Long): MovEquipVisitTercWebServiceModelOutput {
    return with(this){
...
fun MovEquipVisitTercWebServiceModelInput.modelWebServiceToMovEquipVisitTerc(): br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipVisitTerc {
    return with(this){
