...
import br.com.usinasantafe.pcpk.common.utils.BASE_SHARE_PREFERENCES_TABLE_MOV_EQUIP_VISIT_TERC_PASSAG
...
class MovEquipVisitTercPassagDatasourceSharedPreferencesImpl @Inject constructor(
    ...
    override suspend fun listPassag(): List<Long> {
        ...
        val typeToken = object : TypeToken<List<Long>>() {}.type
        val result = sharedPreferences.getString(BASE_SHARE_PREFERENCES_TABLE_MOV_EQUIP_VISIT_TERC_PASSAG, null)
