package br.com.usinasantafe.pcpk.presenter.proprio.detalhemov
...
import br.com.usinasantafe.pcpk.utils.CustomAdapter
import br.com.usinasantafe.pcpk.utils.BaseFragment
import br.com.usinasantafe.pcpk.utils.onBackPressed
import br.com.usinasantafe.pcpk.utils.showGenericAlertDialog
import br.com.usinasantafe.pcpk.utils.showGenericAlertDialogCheck
...
import br.com.usinasantafe.pcpk.presenter.proprio.FragmentAttachListenerProprio
import br.com.usinasantafe.pcpk.presenter.proprio.destino.DestinoProprioFragment.Companion.FLOW_APP_DESTINO_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.destino.DestinoProprioFragment.Companion.POS_DESTINO_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.destino.DestinoProprioFragment.Companion.REQUEST_KEY_DESTINO_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.matric.MatricColabFragment.Companion.POS_MATRIC_COLAB
import br.com.usinasantafe.pcpk.presenter.proprio.matric.MatricColabFragment.Companion.REQUEST_KEY_MATRIC_COLAB
import br.com.usinasantafe.pcpk.presenter.proprio.matric.MatricColabFragment.Companion.TYPE_ADD_OCUPANTE_MATRIC_COLAB
import br.com.usinasantafe.pcpk.presenter.proprio.notafiscal.NotaFiscalProprioFragment.Companion.FLOW_APP_NOTA_FISCAL_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.notafiscal.NotaFiscalProprioFragment.Companion.POS_NOTA_FISCAL_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.notafiscal.NotaFiscalProprioFragment.Companion.REQUEST_KEY_NOTA_FISCAL_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.observ.ObservProprioFragment.Companion.FLOW_APP_OBSERV_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.observ.ObservProprioFragment.Companion.POS_OBSERV_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.observ.ObservProprioFragment.Companion.REQUEST_KEY_OBSERV_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.passag.PassagColabListFragment.Companion.POS_PASSAG_COLAB_LIST
import br.com.usinasantafe.pcpk.presenter.proprio.passag.PassagColabListFragment.Companion.REQUEST_KEY_PASSAG_COLAB_LIST
import br.com.usinasantafe.pcpk.presenter.proprio.passag.PassagColabListFragment.Companion.TYPE_ADD_OCUPANTE_PASSAG_COLAB_LIST
import br.com.usinasantafe.pcpk.presenter.proprio.veiculo.VeiculoProprioFragment.Companion.POS_VEICULO_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.veiculo.VeiculoProprioFragment.Companion.REQUEST_KEY_VEICULO_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.veiculo.VeiculoProprioFragment.Companion.TYPE_ADD_EQUIP_VEICULO_PROPRIO
import br.com.usinasantafe.pcpk.presenter.proprio.veiculoseg.VeiculoSegProprioListFragment.Companion.POS_VEICULO_SEG
import br.com.usinasantafe.pcpk.presenter.proprio.veiculoseg.VeiculoSegProprioListFragment.Companion.REQUEST_KEY_VEICULO_SEG
import br.com.usinasantafe.pcpk.presenter.proprio.veiculoseg.VeiculoSegProprioListFragment.Companion.TYPE_ADD_EQUIP_VEICULO_SEG
