...
import br.com.usinasantafe.pcpk.domain.repositories.stable.VisitanteRepository
...
import br.com.usinasantafe.pcpk.infra.models.room.stable.toVisitante
import br.com.usinasantafe.pcpk.infra.models.room.stable.toVisitanteModel
...
class VisitanteRepositoryImpl @Inject constructor(
    ...
    override suspend fun addAllVisitante(list: List<br.com.usinasantafe.pcpk.domain.entities.stable.Visitante>) {
    ...
    override suspend fun getVisitanteCPF(cpf: String): br.com.usinasantafe.pcpk.domain.entities.stable.Visitante {
        return visitanteDatasourceRoom.getVisitanteCPF(cpf).toVisitante()
    }

    override suspend fun recoverAllVisitante(nroAparelho: Long): Flow<Result<List<br.com.usinasantafe.pcpk.domain.entities.stable.Visitante>>> = flow {
    ...
    override suspend fun getVisitanteId(id: Long): br.com.usinasantafe.pcpk.domain.entities.stable.Visitante {
