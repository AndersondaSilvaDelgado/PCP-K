...
import br.com.usinasantafe.pcpk.infra.datasource.room.variable.MovEquipResidenciaDatasourceRoom
import br.com.usinasantafe.pcpk.infra.datasource.sharedpreferences.MovEquipResidenciaDatasourceSharedPreferences
import br.com.usinasantafe.pcpk.infra.datasource.webservice.variable.MovEquipResidenciaDatasourceWebService
import br.com.usinasantafe.pcpk.infra.models.room.variable.entityToMovEquipResidenciaRoomModel
import br.com.usinasantafe.pcpk.infra.models.room.variable.modelRoomToMovEquipResidencia
import br.com.usinasantafe.pcpk.infra.models.sharedpreferences.modelSharedPreferencesToMovEquipResidencia
import br.com.usinasantafe.pcpk.infra.models.webservice.entityToMovEquipResidenciaWebServiceModel
import br.com.usinasantafe.pcpk.infra.models.webservice.modelWebServiceToMovEquipResidencia
...
class MovEquipResidenciaRepositoryImpl @Inject constructor (
    ...
    override suspend fun deleteMovEquipResidencia(movEquipResidencia: br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipResidencia): Boolean {
        try {
    ...
    override suspend fun listMovEquipResidenciaOpen(): List<br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipResidencia> {
        return movEquipResidenciaDatasourceRoom.listMovEquipResidenciaOpen().map { it.modelRoomToMovEquipResidencia() }
    }

    override suspend fun listMovEquipResidenciaStarted(): List<br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipResidencia> {
        return movEquipResidenciaDatasourceRoom.listMovEquipResidenciaEmpty().map { it.modelRoomToMovEquipResidencia() }
    }

    override suspend fun listMovEquipResidenciaSend(): List<br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipResidencia> {
        return movEquipResidenciaDatasourceRoom.listMovEquipResidenciaSend().map { it.modelRoomToMovEquipResidencia() }
    }

    override suspend fun listMovEquipResidenciaSent(): List<br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipResidencia> {
        return movEquipResidenciaDatasourceRoom.listMovEquipResidenciaSent().map { it.modelRoomToMovEquipResidencia() }
    }

    override suspend fun receiverSentMovEquipResidencia(movEquipList: List<br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipResidencia>): Boolean {
    ...
    override suspend fun sendMovEquipResidencia(
        movEquipList: List<br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipResidencia>,
        nroAparelho: Long
    ): Result<List<br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipResidencia>> {
    ...
    override suspend fun setStatusCloseMov(movEquipResidencia: br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipResidencia): Boolean {
        try {
    ...
    override suspend fun setStatusSendCloseMov(movEquipResidencia: br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipResidencia): Boolean {
        return try {
