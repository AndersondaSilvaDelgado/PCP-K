...
import br.com.usinasantafe.pcpk.infra.models.room.stable.toLocal
import br.com.usinasantafe.pcpk.infra.models.room.stable.toLocalModel
...
class LocalRepositoryImpl @Inject constructor(
    ...
    override suspend fun addAllLocal(list: List<br.com.usinasantafe.pcpk.domain.entities.stable.Local>) {
    ...
    override suspend fun listAllLocal(): List<br.com.usinasantafe.pcpk.domain.entities.stable.Local> {
        return localDatasourceRoom.listAllLocal().map { it.toLocal() }
    }

    override suspend fun recoverAllLocal(nroAparelho: Long): Flow<Result<List<br.com.usinasantafe.pcpk.domain.entities.stable.Local>>> = flow {
    ...
    override suspend fun getLocalId(id: Long): br.com.usinasantafe.pcpk.domain.entities.stable.Local {
