...
import br.com.usinasantafe.pcpk.infra.datasource.room.stable.EquipDatasourceRoom
...
import br.com.usinasantafe.pcpk.infra.models.room.stable.toEquip
import br.com.usinasantafe.pcpk.infra.models.room.stable.toEquipModel
...
class EquipRepositoryImpl @Inject constructor(
    ...
    override suspend fun addAllEquip(list: List<br.com.usinasantafe.pcpk.domain.entities.stable.Equip>) {
    ...
    override suspend fun recoverAllEquip(nroAparelho: Long): Flow<Result<List<br.com.usinasantafe.pcpk.domain.entities.stable.Equip>>> = flow {
    ...
    override suspend fun getEquipNro(nro: Long): br.com.usinasantafe.pcpk.domain.entities.stable.Equip {
        return equipDatasourceRoom.getEquipNro(nro).toEquip()
    }

    override suspend fun getEquipId(id: Long): br.com.usinasantafe.pcpk.domain.entities.stable.Equip {
