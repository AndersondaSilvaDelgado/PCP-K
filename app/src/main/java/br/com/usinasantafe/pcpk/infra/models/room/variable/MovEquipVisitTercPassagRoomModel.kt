...
fun br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipVisitTercPassag.entityToMovEquipVisitTercPassagRoomModel(idMov: Long): MovEquipVisitTercPassagRoomModel{
    return with(this){
...
fun MovEquipVisitTercPassagRoomModel.modelRoomToMovEquipVisitTercPassag(): br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipVisitTercPassag {
    return with(this){
