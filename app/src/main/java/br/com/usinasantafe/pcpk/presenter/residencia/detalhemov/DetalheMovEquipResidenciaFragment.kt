package br.com.usinasantafe.pcpk.presenter.residencia.detalhemov
...
import br.com.usinasantafe.pcpk.presenter.residencia.FragmentAttachListenerResidencia
import br.com.usinasantafe.pcpk.presenter.residencia.motorista.MotoristaResidenciaFragment.Companion.FLOW_APP_MOTORISTA_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.motorista.MotoristaResidenciaFragment.Companion.POS_MOTORISTA_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.motorista.MotoristaResidenciaFragment.Companion.REQUEST_KEY_MOTORISTA_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.observ.ObservResidenciaFragment.Companion.FLOW_APP_OBSERV_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.observ.ObservResidenciaFragment.Companion.POS_OBSERV_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.observ.ObservResidenciaFragment.Companion.REQUEST_KEY_OBSERV_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.observ.ObservResidenciaFragment.Companion.TYPE_MOV_OBSERV_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.placa.PlacaResidenciaFragment.Companion.FLOW_APP_PLACA_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.placa.PlacaResidenciaFragment.Companion.POS_PLACA_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.placa.PlacaResidenciaFragment.Companion.REQUEST_KEY_PLACA_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.veiculo.VeiculoResidenciaFragment.Companion.FLOW_APP_VEIC_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.veiculo.VeiculoResidenciaFragment.Companion.POS_VEIC_RESIDENCIA
import br.com.usinasantafe.pcpk.presenter.residencia.veiculo.VeiculoResidenciaFragment.Companion.REQUEST_KEY_VEIC_RESIDENCIA
