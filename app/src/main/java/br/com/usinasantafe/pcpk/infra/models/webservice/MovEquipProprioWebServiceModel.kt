...
fun br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipProprio.entityToMovEquipProprioWebServiceModel(nroAparelho: Long): MovEquipProprioWebServiceModelOutput {
    return with(this){
...
fun MovEquipProprioWebServiceModelInput.modelWebServiceToMovEquipProprio(): br.com.usinasantafe.pcpk.domain.entities.variable.MovEquipProprio {
    return with(this){
